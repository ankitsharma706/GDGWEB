const Footer = () => {
  return (
    <footer className=" bg-gradient-to-br from-indigo-300  to-purple-500  border-t border-gray-200 py-16">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="text-center md:text-left">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="text-2xl font-normal text-gray-50">GDG ITER</h3>
              </div>
            ...
            <div className="text-center">
              <h4 className="text-lg font-medium mb-6 text-gray-50">
                Quick Links
              </h4>
              <div className="space-y-3">
                <a
                  href="#"
                  className="block text-gray-100 hover:text-blue-600 transition-colors duration-200"
                >
                  Past Events
                </a>
                <a
            ...
            <div className="text-center md:text-right">
              ...
              <div className="flex justify-center md:justify-end space-x-3 mb-6">
                ...
                <a
                  href="#"
                  className="w-10 h-10 bg-gray-600 rounded-full flex items-center justify-center hover:bg-gray-700 transition-colors duration-200"
                >
                  <span className="text-white font-bold text-sm">⚡</span>
                </a>
              </div>
          ...
          <div className="border-t border-gray-200 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <p className="text-gray-100 text-sm mb-4 md:mb-0">
                © 2025 GDG ITER. All rights reserved.
              </p>
              <div className="flex space-x-6 text-sm">
                <a
                  href="#"
                  className="text-gray-100 hover:text-blue-600 transition-colors duration-200"
                >
                  Privacy Policy
                </a>
                <a
