function HomeAbout() {
  return (
    <div className="bg-gradient-to-br from-indigo-300 to-purple-700 via-indigo-500 rounded-2xl shadow-lg p-8 sm:p-10 mb-10 border border-gray-200 hover:border-gray-300 transition-all duration-300">
      <h3 className="text-2xl sm:text-3xl font-bold text-gray-50 mb-6 flex items-center">
        <span className="text-amber-200 mr-3">About Us</span>
      </h3>
